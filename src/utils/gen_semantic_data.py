...
try:
    from utils import load_files, range_projection
except:
    from utils import load_files, range_projection
...
def gen_semantic_data(semantic_folder, scan_folder, dst_folder, proj_H=64, proj_W=900):
    ...
    for idx in range(len(prob_paths)):
        ...
        proj_prob = np.full((proj_H, proj_W, 20), -1, dtype=np.float32)  # [H,W]: probs
...
if __name__ == '__main__':
    semantic_folder = '/home/nana/Desktop/workspace/OverlapNet/data/semantic/probabilities'
    scan_folder = '/home/nana/Desktop/workspace/OverlapNet/data/07/velodyne'
    dst_folder = '/home/nana/Desktop/workspace/OverlapNet/data/preprocess_data_demo'
