...
class NormalizedCorrelation2D(Layer):
    ...
    def __init__(self, output_dim=1, normalize='euclidean', **kwargs):
        """ Initialization as a layer.
            Args:
              normalize: a string which defines the normalization done:
                        'euclidean': just euclidean normalization
                        'scaling': scale, that result in in range 0..1
                        'standardization': Subtract the mean and then do euclidean normalization
        """
