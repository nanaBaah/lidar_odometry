...
from src.utils.utils import semantic_mapping

sys.path.append(os.path.join(os.path.dirname(__file__), '../src/utils'))
import matplotlib.pyplot as plt
from src.utils import *
import src.utils.gen_depth_data as gen_depth
import src.utils.gen_normal_data as gen_normal
import src.utils.gen_intensity_data as gen_intensity
import src.utils.gen_semantic_data as gen_semantics
...
if __name__ == '__main__':
    # load config file
    config_filename = '/home/nana/Desktop/workspace/OverlapNet/config/demo.yml'  # 'config/demo.yml'
    if len(sys.argv) > 1:
