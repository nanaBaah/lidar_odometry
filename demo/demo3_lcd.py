...
from src.utils.utils import load_calib, load_poses, load_files

sys.path.append(os.path.join(os.path.dirname(__file__), '../src/utils'))
sys.path.append(os.path.join(os.path.dirname(__file__), '../src/two_heads'))
from src.utils import *
from src.two_heads.infer import *
...
if __name__ == '__main__':
    ...
    # Nana Opoku Baah ==============> this commented one should be used instead...
    # covs = np.asarray(covs, dtype=float)
    covs = np.asarray(covs[:-1], dtype=float)
